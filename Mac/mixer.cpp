...
void Mixer::newSlider()
{
    ...
    //Sets slider size
    sliders[indexNo]->setMinimumSize(100,150);
    sliders[indexNo]->setMaximumSize(100,200);
    ...
    sliderBox->setFixedSize(180, 250);
...
void Mixer::constructOutputs() {
    ...
    outputFrame->setFixedSize(1000,700);
...
void Mixer::constructMixer(int output)
{
    ...
    secondFrame->setFixedSize(3800,700);
    ...
    volumeLevel->setFixedSize(3300,300);
   ...
   // mainLayout->addStretch(100);
    ...
    sliderFrame->setFixedSize(3300,350);
