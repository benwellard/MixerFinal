...
void Mixer::newSlider()
{
    ...
    for(curInd = 0;curInd < numIns;curInd++)
    {
        ...
        //QString channelInput = QString::number(usb_mixsel_get_state(0,curInd,mixReference));
    ...
    */
    ...
    curInd = usb_mixsel_get_state(0, indexNo, mixReference);
...
void Mixer::constructMixer(int output)
{
    ...
    sliderFingerArea->setFixedSize(1200,800);
    ...
    mix1slide->setFixedSize(1190,1000);

    //IGNORE
    this->setLayout(superLayout);
    superLayout->addWidget(mainFrame);
    mainFrame->setFixedSize(200,800);
    ...
    outputButton->setFixedSize(100,40);
    ...
    volumeLevel->setFixedSize(3200,300);
