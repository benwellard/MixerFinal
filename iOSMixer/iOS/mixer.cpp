...
void Mixer::newSlider()
{
    ...
    //Sets slider size
    sliders[indexNo]->setMinimumSize(30,100);
    sliders[indexNo]->setMaximumSize(30,100);
    ...
    //QString *channelName = new QString(usb_mixsel_get_input_string(mixReference,indexNo));
    QString * channelName = new QString("TEST");
...
void Mixer::constructOutputs() {
    ...
    for(int i = 0;i < numOuts; i++)
    {
        ...
        outputBox->setFixedSize(700,50);
        outputBox->setStyleSheet("QCheckBox::indicator { width: 50px; height: 50px; }");
    ...
    outputFrame->setFixedSize(1000,500);
...
void Mixer::constructMixer(int output)
{
    ...
    sliderFingerArea->setFixedSize(1500,500);
    ...
    outputButton->setFixedSize(100,20);
    ...
    volumeLevel->setFixedSize(3100,70);
   ...
   // mainLayout->addStretch(100);
    ...
    sliderFrame->setFixedSize(3100,150);
